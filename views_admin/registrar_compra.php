      ...
      <div class="card card-primary">
        ...
        <div class="card-body">
          <div class="form-group">
            ...
            <select class="form-control select2" name="id_proveedor" required>
          ...
          <div class="form-group">
            ...
            <input type="date" name="fc_compra" class="form-control" required>
          </div>

          <div class="form-group">
            <label>IVA (%):</label>
            <input type="number" name="iva" class="form-control" step="0.01" min="0" required>
          </div>
        </div>
      </div>
